...
# Architecture
TARGET_ARCH := arm # ro.bionic.arch
TARGET_ARCH_VARIANT := armeabi-v7a # 64位默认变体
TARGET_CPU_ABI := armeabi-v7a # ro.vendor.product.cpu.abilist64 (至少在小米设备上没有找到ro.product.cpu.abilist)
TARGET_CPU_ABI2 := armeabi# 64位留空
...
# Assertation
TARGET_OTA_ASSERT_DEVICE := t982_ar301 # codename

# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := ohm # ro.product.board
...
# Platform
TARGET_BOARD_PLATFORM := sc2 # ro.board.platform
